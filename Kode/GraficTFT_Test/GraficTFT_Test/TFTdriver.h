...
void writeLetterHelper(int letter_length, int startX, int startY);
void drawLetter(const uint8_t bitmap[],int length,int count,int startx,int starty, int letter, int length_of_letter);
